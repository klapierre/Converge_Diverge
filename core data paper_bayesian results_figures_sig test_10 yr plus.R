...
rawData <- read.csv('C:\\Users\\la pierrek\\Dropbox (Smithsonian)\\working groups\\converge diverge working group\\converge_diverge\\datasets\\LongForm\\for resource type analysis_nov2017\\ForAnalysis_allAnalysis9yr.csv')
...
# 
# write.csv(chainsCommunity2, 'bayesian_output_summary_final plots_9yr_11292017.csv')

chainsCommunity2 <- read.csv('bayesian_output_summary_final plots_9yr_11292017.csv')
...
# chainsFinalMean <- as.data.frame(colMeans(chainsCommunity[,2312:3187]))%>% #may need to delete original four chains dataframes to get this to work
#   add_rownames('parameter')
# names(chainsFinalMean)[names(chainsFinalMean) == 'colMeans(chainsCommunity[, 2312:3187])'] <- 'mean'
# #get sd of parameter values across all runs for each experiment, treatment, etc
# chainsFinalSD <- as.data.frame(colSd(chainsCommunity[,2312:3187]))
# names(chainsFinalSD)[names(chainsFinalSD) == 'colSd(chainsCommunity[, 2312:3187])'] <- 'sd'
# 
...
# 
# write.csv(chainsFinal, 'bayesian_output_mean sd_9yr_11292017.csv')

chainsFinal <- read.csv('bayesian_output_mean sd_9yr_11292017.csv')
...
# write.csv(chainsEquations,'plot mani_equations_9yr_11292017.csv', row.names=F)
...
# 
# write.csv(chainsCommunitySummary, 'bayesian_output_summary_final plots_9yr_11292017.csv')
chainsCommunitySummary <- read.csv('bayesian_output_summary_final plots_9yr_11292017.csv')
