...
anpp <- rbind(bgp, biocon, bowman, clonal, e001, e002, events, exp1, fireplots, gb, imagine, imgers, irg, kgfert, lind, megarich, mnr, nfert, nme, nsfc, oface, pplots, ramps, rhps, rio, rmapc, snfert, t7, tide, uk, wapaclip, watering, wenndex, wet)
