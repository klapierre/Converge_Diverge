...
rawData <- read.csv('C:\\Users\\la pierrek\\Dropbox (Smithsonian)\\working groups\\converge diverge working group\\converge_diverge\\La Pierre_comm difference_final model results_01122018\\8yr or less_abs value\\ForAnalysis_allAnalysisShortAbs.csv')
...
# chains1 <- read.csv('C:\\Users\\la pierrek\\Dropbox (Smithsonian)\\working groups\\converge diverge working group\\converge_diverge\\La Pierre_comm difference_final model results_01122018\\8yr or less_abs value\\simple_mod_effs_coding_interactions_shortabs_0.csv', comment.char='#')
# chains1 <- chains1[-1:-5000,]
# chains2 <- read.csv('C:\\Users\\la pierrek\\Dropbox (Smithsonian)\\working groups\\converge diverge working group\\converge_diverge\\La Pierre_comm difference_final model results_01122018\\8yr or less_abs value\\simple_mod_effs_coding_interactions_shortabs_1.csv', comment.char='#')
# chains2 <- chains2[-1:-5000,]
# chains3 <- read.csv('C:\\Users\\la pierrek\\Dropbox (Smithsonian)\\working groups\\converge diverge working group\\converge_diverge\\La Pierre_comm difference_final model results_01122018\\8yr or less_abs value\\simple_mod_effs_coding_interactions_shortabs_2.csv', comment.char='#')
# chains3 <- chains3[-1:-5000,]
# chains4 <- read.csv('C:\\Users\\la pierrek\\Dropbox (Smithsonian)\\working groups\\converge diverge working group\\converge_diverge\\La Pierre_comm difference_final model results_01122018\\8yr or less_abs value\\simple_mod_effs_coding_interactions_shortabs_3.csv', comment.char='#')
...
# 
# write.csv(chainsCommunity2, 'bayesian_output_summary_expinteractions_abs_01122018.csv')

chainsCommunity2 <- read.csv('bayesian_output_summary_expinteractions_abs_01122018.csv')
...
# 
# write.csv(chainsFinal, 'bayesian_output_mean sd_expinteractions_abs_01122018.csv')

chainsFinal <- read.csv('bayesian_output_mean sd_expinteractions_abs_01122018.csv')
...
# 
# write.csv(chainsCommunitySummary, 'bayesian_output_summary_final plots_expinteraction_abs_01122018.csv')

chainsCommunitySummary <- read.csv('bayesian_output_summary_final plots_expinteraction_abs_01122018.csv')
